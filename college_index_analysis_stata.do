/*
This code builds off of a previously developed longitudinal dataset compiling a variety of variables related to Pell student enrollment, Pell student share, institutional finances, and other variables. Most data pulled from IPEDS NCES, rankings generated using Barron's selectivity ratings. 

The previously developed dataset is organized in long form. Here, we reshape it to wide format to calculate percent change variables from 2011 to 2021, which will be used to generate rankings. The data will then be exported to an Excel file for group review, trend identification, and further analysis.
...
/* Merge in endowment buckets generated while creating the analysis sheet. Collapse data on Pell share, Underrepresented Minority (URM) student enrollment share, Black student enrollment share, and Hispanic student enrollment share by bucket and year. Calculate weighted means by total undergraduate enrollment. */
